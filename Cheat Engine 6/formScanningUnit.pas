...
uses
  ...
  Dialogs, StdCtrls, ComCtrls, ExtCtrls, LResources,CEFuncProc,CEDebugger, debughelper;
...
type
  ...
  public
    ...
    procedure SetSettingsLocation(var Message: TMessage); message ESSettings_const;
...
begin
  ...
  begin
    ...
    if cefuncproc.hypermode<>nil then
      postmessage(cefuncproc.hypermode.HyperscanWindow,wm_user+2,0,0); //wm_user+2=scan memory
