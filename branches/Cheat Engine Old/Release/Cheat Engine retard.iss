...
[Setup]
AppName=Cheat Engine Retarded 5.3
AppVerName=Cheat Engine Retarded 5.3
...
DefaultGroupName=Cheat Engine Retarded 5.3
AllowNoIcons=yes
LicenseFile=..\Release\License.txt
InfoAfterFile=..\Release\readme.txt
OutputBaseFilename=CheatEngine53Retarded
