...
#define IOCTL_CE_HOOKSTEALTHEDITINTS			CTL_CODE(IOCTL_UNKNOWN_BASE, 0x0837, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_CE_ADDCLOAKEDSECTION				CTL_CODE(IOCTL_UNKNOWN_BASE, 0x0838, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_CE_REMOVECLOAKEDSECTION			CTL_CODE(IOCTL_UNKNOWN_BASE, 0x0839, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
