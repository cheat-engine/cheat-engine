...
#define VMCALL_REDIRECTINT3			999999999 //note to self: check what value I gave it when back
#define VMCALL_REDIRECTINT14		999999999 //note to self: check what value I gave it when back
