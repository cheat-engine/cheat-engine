...
begin
  case dntype of
    ...
    ELEMENT_TYPE_I1             : result:='Signed Byte';
    ELEMENT_TYPE_U1             : result:='Unsigned Byte';
    ELEMENT_TYPE_I2             : result:='Signed 2 Byte';
    ELEMENT_TYPE_U2             : result:='Unsigned 2 Byte';
    ELEMENT_TYPE_I4             : result:='Signed 4 Byte';
    ELEMENT_TYPE_U4             : result:='Unsigned 4 Byte';
    ELEMENT_TYPE_I8             : result:='Signed 8 Byte';
    ELEMENT_TYPE_U8             : result:='Unsigned 8 Byte';
