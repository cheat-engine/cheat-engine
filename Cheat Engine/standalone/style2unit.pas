...
procedure TStyle2.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  application.Terminate;
end;

procedure TStyle2.FormShow(Sender: TObject);
var i: Integer;
    ingroups: grouptype;
begin
  style2.Caption:=form1.TrainerTitle;
...
procedure TStyle2.CheckListBox1ClickCheck(Sender: TObject);
begin
