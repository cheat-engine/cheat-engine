...
type
  ...
  TTypeForm = class(TForm)
    ...
    stringByteLengthEdit: TEdit;
    bitLengthEdit: TEdit;
    Label1: TLabel;
    labelBit6: TLabel;
    labelBit7: TLabel;
    bitLengthLabel: TLabel;
    labelBit0: TLabel;
    labelBit1: TLabel;
    labelBit2: TLabel;
    labelBit3: TLabel;
    labelBit4: TLabel;
    labelBit5: TLabel;
    stringByteLengthLabel: TLabel;
    stringByteLengthPanel: TPanel;
...
begin
  ...
  case memrec.vartype of
    ...
    begin
      VarType.itemindex:=7;
      stringByteLengthEdit.text:=inttostr(memrec.Extra.stringData.length);
    ...
    vtByteArray:
    begin
      stringByteLengthEdit.text:=inttostr(memrec.Extra.byteData.bytelength);
      VarType.itemindex:=8;
...
begin
  ...
  begin
    ...
    stringByteLengthPanel.visible:=false;
    stringByteLengthLabel.visible:=false;
    bitLengthLabel.Visible:=true;
  ...
  begin
    ...
    stringByteLengthPanel.visible:=true;
    stringByteLengthLabel.visible:=true;
    clientwidth:=stringByteLengthPanel.left+stringByteLengthPanel.Width;
...
begin
  ...
  begin
    ...
    val(stringByteLengthEdit.Text,bit,err);
  ...
  begin
    val(stringByteLengthEdit.Text,MemoryRecord.Extra.stringData.length,err);
  ...
  begin
    val(stringByteLengthEdit.Text,MemoryRecord.Extra.byteData.bytelength,err);
