 ...
 */
{
  ...
  switch (i)
  {
    ...
    case 1: result="VMCALL executed in VMX root operation";
    case 2: result="VMCLEAR with invalid physical address";
    case 3: result="VMCLEAR with VMXON pointer";
    case 4: result="VMLAUNCH with non-clear VMCS";
    case 5: result="VMRESUME with non-launched VMCS";
    case 6: result="VMRESUME with a corrupted VMCS";
    case 7: result="VM entry with invalid fields";
    case 8: result="VM entry with invalid host-state fields";
    case 9: result="VMPTRLD with invalid physical address";
    case 10: result="VMPTRLD with VMXON pointer";
    case 11: result="VMPTRLD with incorrect VMCS revision identifier";
    case 12: result="VMREAD/VMWRITE from/to unsupported VMCS component";
    case 13: result="VMWRITE to read-only VMCS component";
    case 15: result="VMXON executed in VMX root operation";
    case 16: result="VM entry with invalid executive-VMCS pointer";
    case 17: result="VM entry with non-launched executive-VMCS pointer";
    case 18: result="VM entry with executive-VMCS pointer but not VMXON pointer";
    case 19: result="VMCALL with non-clear VMCS";
    case 20: result="VMCALL with invalid VM-exit control fields";
    case 22: result="VMCALL with incorrect MSEG revision number";
    case 23: result="VMXOFF under dual-monitor treatment of SMIs and SMM";
    case 24: result="VMCALL with invalid SMM-monitor features";
    case 25: result="VM entry with invalid VM-execution control fields in executive VMCS";
    case 26: result="VM entry with events blocked by MOV SS";
